...
_sage_const_35 = Integer(35); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_36 = Integer(36); _sage_const_1 = Integer(1); _sage_const_2021 = Integer(2021); _sage_const_100 = Integer(100); _sage_const_38 = Integer(38); _sage_const_16 = Integer(16); _sage_const_39 = Integer(39); _sage_const_3 = Integer(3); _sage_const_42 = Integer(42); _sage_const_5 = Integer(5); _sage_const_47 = Integer(47); _sage_const_49 = Integer(49); _sage_const_4 = Integer(4); _sage_const_51 = Integer(51); _sage_const_54 = Integer(54); _sage_const_6 = Integer(6); _sage_const_58 = Integer(58); _sage_const_60 = Integer(60); _sage_const_63 = Integer(63); _sage_const_7 = Integer(7); _sage_const_64 = Integer(64); _sage_const_8 = Integer(8); _sage_const_68 = Integer(68); _sage_const_100000 = Integer(100000); _sage_const_75 = Integer(75); _sage_const_77 = Integer(77); _sage_const_9 = Integer(9); _sage_const_78 = Integer(78); _sage_const_10 = Integer(10); _sage_const_9999 = Integer(9999); _sage_const_81 = Integer(81); _sage_const_84 = Integer(84); _sage_const_85 = Integer(85); _sage_const_11 = Integer(11); _sage_const_87 = Integer(87); _sage_const_90 = Integer(90); _sage_const_91 = Integer(91); _sage_const_12 = Integer(12); _sage_const_97 = Integer(97); _sage_const_99 = Integer(99); _sage_const_104 = Integer(104); _sage_const_107 = Integer(107); _sage_const_109 = Integer(109); _sage_const_113 = Integer(113); _sage_const_118 = Integer(118); _sage_const_122 = Integer(122); _sage_const_125 = Integer(125); _sage_const_127 = Integer(127); _sage_const_130 = Integer(130); _sage_const_136 = Integer(136); _sage_const_146 = Integer(146); _sage_const_0p4 = RealNumber('0.4'); _sage_const_151 = Integer(151); _sage_const_154 = Integer(154); _sage_const_158 = Integer(158); _sage_const_161 = Integer(161); _sage_const_175 = Integer(175); _sage_const_178 = Integer(178); _sage_const_181 = Integer(181); _sage_const_13 = Integer(13); _sage_const_265 = Integer(265); _sage_const_267 = Integer(267); _sage_const_273 = Integer(273); _sage_const_277 = Integer(277); _sage_const_279 = Integer(279); _sage_const_283 = Integer(283); _sage_const_317 = Integer(317); _sage_const_341 = Integer(341); _sage_const_348 = Integer(348); _sage_const_15 = Integer(15); _sage_const_354 = Integer(354); _sage_const_361 = Integer(361); _sage_const_376 = Integer(376); _sage_const_17 = Integer(17); _sage_const_379 = Integer(379); _sage_const_383 = Integer(383); _sage_const_18 = Integer(18); _sage_const_386 = Integer(386); _sage_const_391 = Integer(391); _sage_const_19 = Integer(19); _sage_const_412 = Integer(412); _sage_const_440 = Integer(440); _sage_const_20 = Integer(20); _sage_const_446 = Integer(446); _sage_const_447 = Integer(447); _sage_const_21 = Integer(21); _sage_const_449 = Integer(449); _sage_const_22 = Integer(22); _sage_const_453 = Integer(453); _sage_const_552 = Integer(552); _sage_const_559 = Integer(559); _sage_const_569 = Integer(569); _sage_const_572 = Integer(572); _sage_const_581 = Integer(581); _sage_const_586 = Integer(586); _sage_const_597 = Integer(597); _sage_const_601 = Integer(601); _sage_const_613 = Integer(613); _sage_const_615 = Integer(615); _sage_const_623 = Integer(623); _sage_const_625 = Integer(625); _sage_const_639 = Integer(639); _sage_const_642 = Integer(642)## This file (example.sagetex.sage) was *autogenerated* from example.tex with sagetex.sty version 2019/11/14 v3.4.
import sagetex
_st_ = sagetex.SageTeXProcessor('example', version='2019/11/14 v3.4', version_check=False)
try:
...
try:
 ...
 _st_.inline(_sage_const_1 , latex(mod(_sage_const_2021 , _sage_const_100 )))
except:
 _st_.goboom(_sage_const_36 )
try:
 _st_.current_tex_line = _sage_const_38 
 _st_.inline(_sage_const_2 , latex(Integer(mod(_sage_const_2021 , _sage_const_100 ))**_sage_const_16 ))
except:
 _st_.goboom(_sage_const_38 )
try:
 _st_.current_tex_line = _sage_const_39 
 _st_.inline(_sage_const_3 , latex(_sage_const_2021 %_sage_const_42 ))
except:
